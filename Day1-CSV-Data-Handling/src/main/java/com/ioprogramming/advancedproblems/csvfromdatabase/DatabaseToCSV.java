...
public class DatabaseToCSV {
    ...
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/aman";
    private static final String USERNAME = "amansingh992";
    private static final String PASSWORD = "aman@1508";
